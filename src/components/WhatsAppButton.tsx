...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      aria-label="WhatsApp"
      className="fixed bottom-6 left-6 w-14 h-14 bg-[#25D366] text-white border-none rounded-full cursor-pointer flex items-center justify-center z-[99] shadow-[0_4px_20px_rgba(37,211,102,0.4)] transition-all duration-400 hover:bg-[#1EB954] hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(37,211,102,0.5)]"
    >
